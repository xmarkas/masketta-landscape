    ...
    <Box>
      <Grid container display={"flex"} justifyContent={"center"}>
        <Grid size={9}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Masketta Window Washing, Des
                Moines, IA.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Masketta Services, accessible
                from{" "}
                <a
                  href="https://masketta.vercel.app"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://masketta.vercel.app
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: mark@masketta.com</p>
            </li>
            <li>
              <p>By phone number: 5133294660</p>
            </li>
          </ul>
        </Grid>
      </Grid>
